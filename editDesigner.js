if (Meteor.isClient) {
  ...
  Template.editDesigner.events({
    ...
    "submit .save-designer": function(event) {
      ...
      event.target.designer_lastName
        .value = "";
      event.target.designer_description.value = "";
      event
        .target.designer_email.value = "";
      event.target.designer_website
        .value = "";
      event.target.designer_skills.value = "";
      event.target
        .designer_rating.value = "";
